...
class CnnTunningFeatures(CnnLstmFeatures):
    ...
    def get_model(self, datas_for_training):
        ...
        # LSTM layer
        lstm_layer = keras.layers.LSTM(32, return_sequences=True)(hidden4)

        # Transformer encoder after LSTM
        transformer_layer = TransformerEncoder(num_heads=4, intermediate_dim=64, dropout=0.2)(lstm_layer)

        # Global pooling
        gp = keras.layers.GlobalAveragePooling1D()(transformer_layer)
